...
<head>
    ...
    <!-- Title -->
    <title>Sergrade Admin || Delete Blog</title>
</head>
                ...
                <div class="col-12">
                    <div class="card bg-white border-0 shadow-sm p-4">
                        <div class="text-center py-5">
                            ...
                            <h4>Delete Blog</h4>
                            <p>Are you sure you want to reject this blog? it cannot be undone</p>
                            ...
                            if (isset($_POST["delete"])) {
                                ...
                                if ($delete) {
                                    echo "<script>alert('Deleted Successfully!');location.href = 'blogs.php';</script>";
                                } else {
