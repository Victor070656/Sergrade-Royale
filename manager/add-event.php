...
<head>
    ...
    <!-- Title -->
    <title>Sergrade Admin || Add Events</title>
</head>
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                if (isset($_POST["add"])) {
                                                    ...
                                                    if (move_uploaded_file($tmp_name, $path)) {
                                                        $add = $conn->query("INSERT INTO `events`(`title`, `body`, `event_date`, `post_type`, `image`) VALUES ('$title', '$body', '$date', '$post_type', '$image')");
                                                        if ($add) {
                                                            echo "<script>alert('News / Event added successfully'); location.href = 'events.php'</script>";
                                                        } else {
