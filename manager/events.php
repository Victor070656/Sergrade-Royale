...
<head>
    ...
    <!-- Title -->
    <title>Sergrade Admin || Events</title>
</head>
                                ...
                                <table id="tablee" class="w-100 mt-4 table table-bordered mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col text-muted text-uppercase text-nowrap text-center"><small>Event Date</small></th>
                                            <th class="col text-muted text-uppercase text-nowrap text-center"><small>Post Type</small></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td class="">
                                                    <a href="<?= "../assets/uploads/event/" . $row['image'] ?>" target="_blank" rel="noopener noreferrer">
                                                        <img src="<?= "../assets/uploads/event/" . $row['image'] ?>" alt="">
                                                    </a>
                                                </td>
                                                <td class=""><?= $row['title'] ?></td>
                                                <td class="text-truncate" style="max-width: 400px;"><?= $row['body'] ?></td>
                                                <td class=""><?= $row['event_date'] ?></td>
                                                <td class=""><?= $row['post_type'] ?></td>
                                                <td class=""><small><?= $row['created_at'] ?></small></td>
                                                <td class="">
                                                    <a href="edit-event.php?id=<?= $row['id'] ?>" class="btn btn-primary btn-sm mb-1">Edit</a>
                                                    <a href="delete-event.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm mb-1">Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
