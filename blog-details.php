...
<head>
  ...
  <title>Sergrade Royale Overseas Education - Blog - <?= $blog["title"]; ?></title>
  <link
    rel="shortcut icon"
  ...
  <main>
    ...
    <section class="py-5 position-relative">
      ...
      <div class="container" style="position: relative; z-index: 1">
        ...
        <div class="">
          <div class="mb-3">
            <img src="assets/uploads/blog/<?= $blog["image"]; ?>" alt="" class="w-100 rounded-4">
          </div>
          <div class="">
            <span class="badge bg-primary">Blog Post</span>
            <h2><b><?= $blog["title"]; ?></b></h2>
            <div class="mb-3 d-flex column-gap-4">
              <small class="text-primary">Posted on: <?= date("d M, Y", strtotime($blog['created_at'])); ?></small>
            </div>
