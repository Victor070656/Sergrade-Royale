                                                ...
                                                <div class="row row-gap-3">
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            ...
                                                            <input type="text" class="form-control" id="fname" value="<?= $studentInfo['firstname'] ?>" name="fname" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            ...
                                                            <input type="text" class="form-control" id="lname" value="<?= $studentInfo['lastname'] ?>" name="lname" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            <label for="phone" class="form-label">Mobile Number</label>
                                                            <input type="tel" class="form-control" id="phone" value="<?= $studentInfo['phone'] ?>" name="phone">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            <label for="email" class="form-label">Email Address</label> <span class="text-danger">*</span>
                                                            <input type="email" class="form-control" id="email" value="<?= $studentInfo['email'] ?>" name="email" required>
                                                        </div>
                                                    </div>
                                                    <div class="">
                                                        <div class="">
                                                            <label for="password" class="form-label">password</label> <span class="text-danger">*</span>
                                                            <input type="password" class="form-control" id="password" value="<?= $studentInfo['password'] ?>" name="password" required>
                                                        </div>
                                                    </div>
