...
<head>
    ...
    <!-- Title -->
    <title>Sergrade Student || Add Application</title>
</head>
                                ...
                                <div class="card-body px-4 py-5">
                                    <form method="post">
                                        ...
                                        <div class="row row-gap-3">
                                            ...
                                            <div class="">
                                                <button type="submit" name="add" class="btn btn-dark">ADD APPLICATION</button>
                                            </div>
                                        </div>
                                        <?php
                                        if (isset($_POST["add"])) {
                                            ...
                                            `applicant_id`, `student_id`, `first_name`, `middle_name`,
                                            ...
                                            VALUES ('$applicationid','$student_id','$fname','$mname',
                                            '$lname','$dob','$country',
                                            '$state','$email','$marital',
