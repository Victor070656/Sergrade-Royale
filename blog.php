...
$allBlogs = $getBlogs->fetch_all(MYSQLI_ASSOC);
$records_per_page = 10;

$paginator = new Zebra_Pagination();
$paginator->records(count($allBlogs));
                ...
                <div
                  ...
                  <div class="p-3">
                    <!-- <small class="text-primary mb-3">
                      <?= date("d M, Y", strtotime($blog['event_date'])); ?>
                    </small> -->
                    <h4 class="mb-3 text-truncate text-capitalize"><?= $blog['title'] ?></h4>
                    <p class="mb-3" style="max-height: 100px; overflow: hidden;">
                      <?= $blog['body'] ?>
                    </p>
                    <a
                      href="blog-details.php?id=<?= $blog['id'] ?>"
