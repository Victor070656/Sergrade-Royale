...
$getAllApplicants = $conn->query("SELECT * FROM applicants WHERE agent_id = '$agent_id'");
$applicantsA = $getAllApplicants->num_rows;
// 
$getPendingApplicants = $conn->query("SELECT * FROM applicants WHERE agent_id = '$agent_id' AND status = 'pending'");
$applicantsP = $getPendingApplicants->num_rows;
// 
$getRejectedApplicants = $conn->query("SELECT * FROM applicants WHERE agent_id = '$agent_id' AND status = 'rejected'");
...
<head>
    ...
    <!-- Title -->
    <title>Sergrade Agent || Applicants</title>
</head>
